...
#     def test_type_return(self) -> None:
...
#     def test_true_password(self) -> None:
...
#     def test_false_password(self) -> None:
...
#         ]
#     )
#     def test_no_data(self, plain_password, hashed_password) -> None:
