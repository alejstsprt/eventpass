"""create_category_in_events

Revision ID: ce1d6af454b5
Revises: cfd80ec41ab7
Create Date: 2025-06-04 14:16:32.123524
...
revision: str = "ce1d6af454b5"
down_revision: Union[str, None] = "cfd80ec41ab7"
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.VARCHAR(),
            server_default=sa.text("'опубликованно'"),
            nullable=False,
        ),
